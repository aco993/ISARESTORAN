...
namespace Restoran2016.Models
{
    ...
    public partial class aco4Entities : DbContext
    {
        public aco4Entities()
            : base("name=aco4Entities")
        {
        }
        ...
        public virtual DbSet<PRIJATELJI_REZERVACIJA> PRIJATELJI_REZERVACIJA { get; set; }
        public virtual DbSet<RESTORAN> RESTORANs { get; set; }
        public virtual DbSet<REZERVACIJA> REZERVACIJAs { get; set; }
        public virtual DbSet<STO> STOes { get; set; }
    
        [DbFunction("aco4Entities", "Slobodni_Stolovi")]
        public virtual IQueryable<Slobodni_Stolovi_Result> Slobodni_Stolovi(Nullable<System.DateTime> dATUM, Nullable<System.DateTime> pOCETNO_VREME, Nullable<System.DateTime> kRAJNJE_VREME)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Slobodni_Stolovi_Result>("[aco4Entities].[Slobodni_Stolovi](@DATUM, @POCETNO_VREME, @KRAJNJE_VREME)", dATUMParameter, pOCETNO_VREMEParameter, kRAJNJE_VREMEParameter);
        }
        ...
        public virtual int unosStolova(Nullable<int> broj_stolova, string id_restorana)
        {
            var broj_stolovaParameter = broj_stolova.HasValue ?
                new ObjectParameter("broj_stolova", broj_stolova) :
                new ObjectParameter("broj_stolova", typeof(int));
    
            var id_restoranaParameter = id_restorana != null ?
                new ObjectParameter("id_restorana", id_restorana) :
                new ObjectParameter("id_restorana", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("unosStolova", broj_stolovaParameter, id_restoranaParameter);
        }
    }
}
